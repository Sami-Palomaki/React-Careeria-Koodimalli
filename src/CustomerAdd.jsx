...
const handleSubmit = (event) => {
    ...
    return (
            <div id='addNew'>
                ...
                <div>
                    <input type="text" value={newCustomerId} onChange={({target}) => setNewCustomerId(target.value)} required placeholder='ID with 5 capital letters' maxLength="5" minLength="5" />
                </div>
                <div>
